...
{
public:
	GlassMat(SimpleVertexShader* vShader, SimplePixelShader* pShader, ID3D11ShaderResourceView* SRV, ID3D11ShaderResourceView* refractSRV, ID3D11SamplerState* SS) :
		Material(vShader, pShader, SRV, SS) 
	{
